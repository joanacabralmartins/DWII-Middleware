...
<html lang="pt-br">
    <head>
        ...
        <title>Trabalho Bimestral - @yield('titulo')</title>
    ...
    <body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('profs.index')}}" class="dropdown-item">Professores</a></li>
        ...
        <nav class="navbar fixed-bottom navbar-dark bg-secondary">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; IFPR - Instituto Federal do Paraná</span>
            </div>
        </nav>
    </body>
